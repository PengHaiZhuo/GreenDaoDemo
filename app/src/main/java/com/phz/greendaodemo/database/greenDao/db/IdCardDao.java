...
public class IdCardDao extends AbstractDao<IdCard, String> {
    ...
    public static class Properties {
        ...
        public final static Property IdNum = new Property(1, String.class, "idNum", false, "ID_NUM");
    }
    ...
    public IdCard readEntity(Cursor cursor, int offset) {
        IdCard entity = new IdCard( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1) // idNum
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, IdCard entity, int offset) {
        ...
        entity.setIdNum(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
     }

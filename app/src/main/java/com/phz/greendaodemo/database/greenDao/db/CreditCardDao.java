...
public class CreditCardDao extends AbstractDao<CreditCard, Long> {
    ...
    public static class Properties {
        ...
        public final static Property CarNum = new Property(4, String.class, "carNum", false, "CAR_NUM");
    ...
    public CreditCard readEntity(Cursor cursor, int offset) {
        CreditCard entity = new CreditCard( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // carNum
    ...
    public void readEntity(Cursor cursor, CreditCard entity, int offset) {
        ...
        entity.setCarNum(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
